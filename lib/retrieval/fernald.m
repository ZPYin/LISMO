function [aerBsc, aerBscStd, aerBR, aerBRStd] = fernald(alt, signal, bg, LR_aer, ...
    refAlt, refBeta, molBSC, window_size)
% FERNALD fernald retrieve the aerosol backscattering coefficient with Fernald method. 
%
% USAGE:
%   [aerBsc, aerBscStd, aerBR, aerBRStd] = fernald(alt, signal, bg, ...
...
%
% HISTORY:
%    2022-05-30: first edition by Zhenping
