...
if ~ishold(cax);
    ...
    createSpokes(thetaMin,thetaMax,Ncircles,circPos,Nspokes, gridLineStyle);
    createCircles(rMin,rMax,thetaMin,thetaMax,Ncircles,circPos,Nspokes, gridLineStyle)
end
...
% Nested functions
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function createSpokes(thetaMin,thetaMax,Ncircles,circlesPos,Nspokes, linestyle)
        ...
        for kk = 1:Nspokes
            ...
            plot(X,Y,'color',[0.5,0.5,0.5],'linewidth',0.75,...
                'handlevisibility','off', 'LineStyle', linestyle);
    ...
    function createCircles(rMin,rMax,thetaMin,thetaMax,Ncircles,circlePos,Nspokes, linestyle)
        ...
        for kk=1:length(contourD)
            X = xGrid*contourD(kk);
            Y = yGrid*contourD(kk);
            plot(X,Y,'color',[0.5,0.5,0.5],'linewidth',1, 'LineStyle', linestyle);
        end
        % radius tick label
