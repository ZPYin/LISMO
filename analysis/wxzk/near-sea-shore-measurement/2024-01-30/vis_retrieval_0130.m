...
scanTime2Plot = datenum(2024, 1, 30, 20, 21, 0);   % temporal range for data input
distOffset = -48.75;
iCh = 1;
flagReadScanData = true;
flagReadAllDayData = false;
flagAve4Vis = false;
iPrfInScan4Vis = 6;
flagOverlapCor = true;
olHeight = 1000;
...
%% lidar calibration
meanRCS = nanmean(scanData.rcs(caliProfiIdx, :), 1);
