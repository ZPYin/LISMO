...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\12月28无人艇出海数据';
distOffset = 55.75;
tRange = [datenum(2023, 12, 28, 11, 0, 0), datenum(2023, 12, 28, 11, 5, 0)];   % temporal range for data input
olFile = 'overlap_20231228.mat';
linFitRange = [500, 1000];
