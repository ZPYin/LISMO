...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\11';   % input a scanning period. Path of scanning data.
tRange = [datenum(2023, 11, 3, 8, 4, 0), datenum(2023, 11, 3, 17, 6, 0)];   % temporal range for data input
tCaliRange = [datenum(2023, 11, 3, 17, 0, 0), datenum(2023, 11, 3, 17, 4, 0)];
distOffset = 55.75;
olHeight = 300;   % 
refDist = [3000, 3500];
...
flagReadData = true;
overlapCor = true;
overlapFile = 'overlap_20231103.mat';
