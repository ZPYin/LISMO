...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\11';
distOffset = 55.75;
tRange = [datenum(2023, 11, 3, 17, 0, 0), datenum(2023, 11, 3, 17, 2, 0)];   % temporal range for data input
olFile = 'overlap_20231103.mat';
