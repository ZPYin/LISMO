...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\12月26无人艇出海数据';   % input a scanning period. Path of scanning data.
tRange = [datenum(2023, 12, 26, 9, 2, 0), datenum(2023, 12, 26, 16, 21, 0)];   % temporal range for data input
tCaliRange = [datenum(2023, 12, 26, 15, 0, 0), datenum(2023, 12, 26, 15, 3, 0)];
distOffset = 55.75;
olHeight = 300;   % 
refDist = [3000, 3500];
calDist = [2000, 3000];% fog lidar with polarization
lr = 30;
maxRange = 10;   % km
visRetMethod = 'xian';
flagReadData = true;
overlapCor = true;
overlapFile = 'overlap_20231226.mat';
