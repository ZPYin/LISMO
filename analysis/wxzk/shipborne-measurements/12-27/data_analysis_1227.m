...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\12月27无人艇出海数据';   % input a scanning period. Path of scanning data.
tRange = [datenum(2023, 12, 27, 9, 4, 0), datenum(2023, 12, 27, 14, 29, 0)];   % temporal range for data input
tCaliRange = [datenum(2023, 12, 27, 13, 24, 0), datenum(2023, 12, 27, 13, 34, 0)];
distOffset = 55.75;
olHeight = 300;   % 
refDist = [800, 1000];
calDist = [500, 800];
...
flagReadData = false;
overlapCor = true;
overlapFile = 'overlap_20231227.mat';
...
s2 = plot(lData.startTime, vis(:, 30) * 1e-3, 'color', 'b', 'Marker', '.', 'MarkerFaceColor', 'b', 'markeredgecolor', 'b', 'DisplayName', sprintf('激光测雾雷达(%3d米)', floor(range(30))));
hold off;
