...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\12月27无人艇出海数据';
distOffset = 55.75;
tRange = [datenum(2023, 12, 27, 13, 24, 0), datenum(2023, 12, 27, 13, 30, 0)];   % temporal range for data input
