...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\无人艇12月18、29数据\12.18';
distOffset = 55.75;
tRange = [datenum(2023, 12, 18, 8, 40, 0), datenum(2023, 12, 18, 8, 45, 0)];   % temporal range for data input
olFile = 'overlap_20231218.mat';
linFitRange = [1500, 3000];
