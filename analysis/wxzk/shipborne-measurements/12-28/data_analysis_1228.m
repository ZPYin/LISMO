...
dataFolder = 'C:\Users\ZPYin\Documents\Data\wxzk_fog_measurements\海试数据、效果图\12月28无人艇出海数据';   % input a scanning period. Path of scanning data.
tRange = [datenum(2023, 12, 28, 9, 16, 0), datenum(2023, 12, 28, 12, 48, 0)];   % temporal range for data input
tCaliRange = [datenum(2023, 12, 28, 11, 0, 0), datenum(2023, 12, 28, 11, 10, 0)];
distOffset = 55.75;
olHeight = 300;   % 
refDist = [800, 1000];
calDist = [500, 800];
...
s2 = plot(lData.startTime, vis(:, 80) * 1e-3, 'color', 'b', 'Marker', '.', 'MarkerFaceColor', 'b', 'markeredgecolor', 'b', 'DisplayName', sprintf('激光测雾雷达(%3d米)', floor(range(80))));
hold off;
