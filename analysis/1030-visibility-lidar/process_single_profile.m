...
tRange = datenum(2026, 5, 2, 0, 0, 0);   % 选择的廓线时间
visSensorFile = 'vis-sensor-data.mat';   % 前向散射能见度仪数据文件
l0Folder = 'G:\backup\vis-lidar\20260428-tianjin-evaluation\前散仪对比数据\VIS2\L0';   % 雷达原始数据文件目录
l1Folder = 'G:\backup\vis-lidar\20260428-tianjin-evaluation\前散仪对比数据\VIS2\L1';   % 雷达产品文件目录
...
lr = 50;   % 雷达比
dist_vis_lidar = 2;   % 前向散射能见度仪与激光雷达距离（千米）
refH = [8, 9];   % Fernald方法参考距离（千米）
