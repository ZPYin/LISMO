...
savePath = 'H:\research\vislidar-intercomparison\tianjing';   % 图片结果输出目录
dateStrs = {'20260503', '20260504', '20260505'};
...
for iDate = 1:length(dateStrs)
    dateStr = dateStrs{iDate};

    %% Read Data
    mDate = datenum(dateStr, 'yyyymmdd');
    ...
    normRatio1v2 = mean(rcs1(200:700, 1), 1) ./ mean(rcs2(200:700, 1), 1);
    ...
    export_fig(gcf, fullfile(savePath, sprintf('%s_THI_intercomparison.png', datestr(mTime1(1), 'yyyymmdd'))), '-r300');
    ...
    export_fig(gcf, fullfile(savePath, sprintf('%s_correlation_coefficient.png', datestr(mTime1(1), 'yyyymmdd'))), '-r300');
end