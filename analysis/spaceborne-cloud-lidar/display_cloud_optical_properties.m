...
p2 = plot(wavelength, extinction(2, :), 'LineStyle', '-', 'Color', 'b', 'LineWidth', 2, 'DisplayName', 'Severe Advection fog'); hold on;
...
title('Optical properties for stratocumulus cloud');
...
p2 = plot(wavelength, backscatter(2, :), 'LineStyle', '-', 'Color', 'b', 'LineWidth', 2, 'DisplayName', 'Severe Advection fog'); hold on;
...
p2 = plot(wavelength, extinction(2, :) ./ backscatter(2, :), 'LineStyle', '-', 'Color', 'b', 'LineWidth', 2, 'DisplayName', 'Severe Advection fog'); hold on;
