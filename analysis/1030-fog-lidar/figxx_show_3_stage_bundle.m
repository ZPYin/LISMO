...
telRX = 3:0.01:10;
telRY = 2 / 68^2 * (telRX.^2 - 68^2);
telLX = -10:0.01:-3;
telLY = 2 / 68^2 * (telLX.^2 - 68^2);
...
p4 = plot(telRX, telRY, 'LineWidth', 2, 'Color', 'k', 'DisplayName', 'Primary Mirror');
p5 = plot(telLX, telLY, 'LineWidth', 2, 'Color', 'k', 'DisplayName', 'Primary Mirror');
hold off;
